...
--> statement-breakpoint
CREATE TABLE "hot_change_logs" (
	"block_height" integer NOT NULL,
	"index" integer NOT NULL,
	"change" jsonb NOT NULL,
	"created_at" timestamp DEFAULT current_timestamp NOT NULL,
	"updated_at" timestamp DEFAULT current_timestamp NOT NULL,
	CONSTRAINT "hot_change_logs_block_height_index_pk" PRIMARY KEY("block_height","index")
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "hot_change_logs" ADD CONSTRAINT "hot_change_logs_block_height_hot_blocks_height_fk" FOREIGN KEY ("block_height") REFERENCES "public"."hot_blocks"("height") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
